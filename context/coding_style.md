...
This guide is written in the spirit of [Google Style Guides](https://github.com/google/styleguide), especially the most well written ones like for [Markdown](https://github.com/google/styleguide/blob/gh-pages/docguide/style.md), [documentation style](https://github.com/google/styleguide/blob/gh-pages/docguide/best_practices.md), [HTML](https://github.com/google/styleguide/blob/gh-pages/htmlcssguide.html), and [JSON](https://github.com/google/styleguide/blob/gh-pages/jsoncstyleguide.xml). For React, see [React Style Guide](https://github.com/airbnb/javascript/tree/master/react) and [React Hooks Style Guide](https://github.com/airbnb/javascript/tree/master/react/hooks).
...
**Further Reading**: [Joel on Software](https://www.joelonsoftware.com/2005/05/11/making-wrong-code-look-wrong/)
...
With thanks to Skylar Payne for the original [style guide](https://skylarbpayne.com/posts/my-cursor-setup)
